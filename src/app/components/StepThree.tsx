    ...
    <div className="max-w-6xl mx-auto space-y-7 lg:space-y-14">
      ...
      <div className="grid lg:grid-cols-3 gap-10 lg:gap-0">
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="lg:w-2/3 bg-btn-gr self-center hover:bg-btn-gr-reverse flex items-center text-base justify-center gap-7 text-white rounded-full transition-all duration-200 px-5 py-3"
          >
