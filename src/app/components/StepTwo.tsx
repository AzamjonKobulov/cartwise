  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 md:space-y-14">
      ...
      <form className="flex flex-col gap-5 md:text-lg lg:text-xl">
        <label
          htmlFor="phone"
          className="flex flex-col lg:flex-row items-start sm:items-center justify-between gap-1.5 md:text-xl font-medium cursor-pointer"
        >
          <span>Phone</span>
          <input
            type="text"
        ...
        <label
          htmlFor="numberpeople"
          className="flex items-start items-center justify-between gap-1.5 md:text-xl font-medium cursor-pointer"
        >
          <span>Annual Savings</span>
          <span className="md:w-1/2 text-start sm:py-5">1000$</span>
        </label>
      </form>
    </div>
  );
